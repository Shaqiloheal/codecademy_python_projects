...
for transaction in daily_transactions_split:
  transaction_clean = []  # NOTE list per "transaction" of transactions
  for data in transaction:
    transaction_clean.append(data.strip(" ").strip("\n"))
...
def colour_count(colour):
  ...
  for thread_colour in thread_sold_split:
    if colour ==  thread_colour:
      colour_total += 1
  return colour_total
#print(colour_count("red"))

colours = ['red', 'yellow', 'green', 'white', 'black', 'blue', 'purple']

for colour in colours:
  print("Thread Shed sold {0} threads of {1} thread today.".format(colour_count(colour), colour))
